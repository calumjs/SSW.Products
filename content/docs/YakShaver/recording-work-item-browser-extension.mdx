...
seo:
  ...
  description: >-
    Learn how to use the YakShaver browser extension to record tasks from screen
    recordings. Capture work items effortlessly as you code.
title: 'Tools: Recording a Work Item - Browser Extension'
...
5. Choose your screen or application window to record (full screen is recommended for best results)
6. Enable system audio sharing if you're recording a call to capture all participants' voices

   ![](/YakShaver/Docs/Computer-audio.png)
   **Figure: system audio sharing options**
7. Allow Microphone permission to the tab when requested
8. Perform the task you want to document, explaining what you're doing
9. Click "Stop Recording" when finished
10. YakShaver will automatically process your recording and create a ticket
11. Review your newly created work item by opening the generated ticket
