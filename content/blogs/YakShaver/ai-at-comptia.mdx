...
summaryCard: true
summary: >
  ## SSW at CompTIA: AI in Action


  SSW General Manager Ulysses shared how tools like YakShaver simplify task
  delegation and issue reporting using AI.
  ...
  ***
  ...
  Even non-technical team members, like designers, found YakShaver
  intuitive—just “one and done.”
  ...
  ***
  ...
  YakShaver automatically routes tasks, reducing manual coordination and
  improving Sprint efficiency.
  ...
  ***
  ...
  Ulysses showcased real-world examples of AI improving workflows without added
  complexity—a message that resonated with the audience.
---
